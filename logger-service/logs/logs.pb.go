...
type Log struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // Field Tag 1: Định danh duy nhất cho trường dữ liệu trong quá trình truyền tải nhị phân. Không phải giá trị của biến, mà là ID để hệ thống giải mã (decode) cực nhanh
	Data          string                 `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"` // Field Tag 1: Định danh duy nhất cho trường dữ liệu trong quá trình truyền tải nhị phân. Không phải giá trị của biến, mà là ID để hệ thống giải mã (decode) cực nhanh
